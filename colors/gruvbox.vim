...
let s:gb.wheat          = ['#ffffd7', 229]
let s:gb.bright_red     = ['#fb4934', 161]     " 251-73-52
let s:gb.bright_green   = ['#b8bb26', 112]     " 184-187-38
let s:gb.bright_yellow  = ['#fabd2f', 214]     " 250-189-47
let s:gb.bright_blue    = ['#83a598', 81]     " 131-165-152
let s:gb.bright_purple  = ['#d3869b', 141]     " 211-134-155
let s:gb.bright_aqua    = ['#8ec07c', 81]     " 142-192-124
...
let s:gb.faded_yellow   = ['#b57614', 229]     " 181-118-20
...
call s:HL('GruvboxAquaBold', s:blue, s:none, s:bold)
...
if g:gruvbox_improved_strings == 0
  hi! link Special GruvboxPurple
else
  call s:HL('Special', s:purple, s:bg1, s:italicize_strings)
endif
...
hi! link Character GruvboxGreen
" String constant: "this is a string"
if g:gruvbox_improved_strings == 0
  call s:HL('String', s:gb.faded_yellow, s:none, s:italicize_strings)
else
  call s:HL('String', s:gb.faded_yellow, s:bg1, s:italicize_strings)
endif
